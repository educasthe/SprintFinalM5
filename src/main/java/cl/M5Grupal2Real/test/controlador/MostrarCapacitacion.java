...
/**
 * Servlet implementation class MostrarCapacitacion
 */
@WebServlet("/MostrarCapacitacion")
public class MostrarCapacitacion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MostrarCapacitacion() {
        super();
